...
public class MultiRoundsTest {
    ...
    public void fiveRoundThreeCorrect() {
        ...
        betFacade.addBetToMatch(new NewBetDTO(BetType.DRAW, matchUUID3), auth.getToken());
        betFacade.addBetToMatch(new NewBetDTO(BetType.DRAW, matchUUID4), auth.getToken());
        betFacade.addBetToMatch(new NewBetDTO(BetType.DRAW, matchUUID5), auth.getToken());
